...
Pod::Spec.new do |s|
  s.name             = 'sinesp'
  s.version          = '0.1.0'
  s.summary          = 'A short description of sinesp.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/sinesp'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Francesco Perrotti-Garcia' => 'fpg1503@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/sinesp.git', :tag => s.version.to_s }
